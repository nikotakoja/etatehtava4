		...
		<table>
			<thead>
				<tr>
					...
					<th style="height: 10px" colspan="5" class="oikealle"><a
...
<script>
	...
	fetch("asiakkaat/haeyksi/" + asiakas_id, {//Lähetetään kutsu backendiin
		...
		document.getElementById("etunimi").value = responseJson.merkki;
		document.getElementById("sukunimi").value = responseJson.malli;
		document.getElementById("puhelin").value = responseJson.vuosi;
		document.getElementById("sposti").value = responseJson.rekno;
	});
